...
public class ListarNacionalidadesUtil {
	...
	public static String[] filtrarNacionalidades() {
		String[] nacionalidades = { "Afghanistan – Afeganistão", "Afghan – afegão", "Andorra – Andorra",
				"Andorran – andorrano", "Angola – Angola", "Angolan – angolano",
	...
	private static boolean esNacionalidadEspanhol(String nacionalidad) {
		String regEx = "(([A-Z][\\-]?[a-záéíóúâêôãõç]+)(\\s|\\-)?" + "([A-Z]?[\\-]?[a-záéíóúâêôãõç]+\\s)?–\\s"
