...
public class Mensaje {
	...
	public static void confirmarSalida(java.awt.event.MouseEvent evt) {
		...
		int eleccion = JOptionPane.showOptionDialog(null, "En realidad desea realizar cerrar la aplicacion",
				"Mensaje de Confirmación", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opciones,
				"Aceptar");
	...
	public static void cancelarRegistro(java.awt.event.MouseEvent evt, RegistrarHuesped huesped) {
		...
		int eleccion = JOptionPane.showOptionDialog(null,
				...
				"Confirmar cancelación de registro.", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE, null,
				opciones, "Aceptar");
		if (eleccion == JOptionPane.YES_OPTION) {
			evt.consume();
	...
	public static void cancelarRegistro(java.awt.event.MouseEvent evt, RegistrarUsuario registrarUsuario) {
		...
		int eleccion = JOptionPane.showOptionDialog(null,
				...
				"Confirmar cancelación de registro de Usuario.", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE,
