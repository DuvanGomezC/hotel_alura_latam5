...
public class Reserva {
	...
	public String toString() {
		return String.format("{ID: %s, FechaEntrada: %s, FechaSalida: %s, Total: %f, FormaPago: %s}", this.idReserva,
				this.fechaEntrada, this.fechaSalida, this.valorReserva, this.formaPago);
	}
}
