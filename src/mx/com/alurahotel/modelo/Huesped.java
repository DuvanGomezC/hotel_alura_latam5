...
public class Huesped {
	...
	public String toString() {
		return String.format(
				"{ID: %s, Nombre: %s, Apellido: %s, FechaNacimiento: %s, Nacionalidad: %s, Teléfono: %s, ID_Reserva: %s}",
				this.idHuesped, this.nombre, this.apellido, this.fechaNacimiento, this.nacionalidad, this.telefono,
				this.idReserva);
	}
}
